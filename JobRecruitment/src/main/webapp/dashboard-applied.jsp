...
<html lang="en">
          ...
          <div class="col-md-6">
            <div class="breadcrumb-area">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="/JobRecruitment/jobTypeList.action?jspName=index">Home</a></li>
              ...
              <div class="dashboard-sidebar">
                ...
                <div class="dashboard-menu">
                  <ul>
                    ...
                    <li class="active"><i class="fas fa-check-square"></i><a href="queryAuserApplyJobs.action">Applied Job</a></li>
                  </ul>
                  <ul class="delete">
  ...
  function remove(jobid) {
	  $.ajax({
          type:"post",
          url:"deleteApplyJob.action?jobid="+jobid,
          dataType:"json",
          success:function(data){
       	  if (data.info=="ok") {
            $("#div"+jobid).remove();
