                    ...
                    <div class="row">
                      ...
                      <div class="col-md-9">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <input type="password" class="form-control" placeholder="Job Location">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <input type="password" class="form-control" placeholder="Salary Range">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <input type="password" class="form-control" placeholder="Vacancy">
                            </div>
                          </div>
                          <div class="col-md-6">
