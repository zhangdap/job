            ...
            <div class="header-top">
              ...
              <div class="top-nav">
                ...
                <div class="dropdown header-top-account">
                  <a href="/JobRecruitment/jobTypeList.action?jspName=index" class="account-button">${loginUser.username }</a>
              ...
              <div class="dashboard-sidebar">
                ...
                <div class="dashboard-menu">
                  <ul>
                    ...
                    <li class="active"><i class="fas fa-file-alt"></i><a href="resumeinfo.action?jspName=resume">Resume</a></li>
